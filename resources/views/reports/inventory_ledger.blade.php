        ...
        <div class="card border-0 shadow-sm" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
            <div class="card-body text-white">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="card-title mb-1 text-white-50">Purchases Received</h6>
    ...
    <div class="col-md-3">
        <div class="card border-0 shadow-sm" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%);">
            <div class="card-body text-white">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="card-title mb-1 text-white-50">Sales Completed</h6>
...
<div class="card">
    <div class="card-header">
        <h6 class="card-title">Inventory Ledger</h6>
        <p class="card-subtitle">Filter inventory movements by date range and print the ledger.</p>
    </div>
    <div class="card-body">
        <form id="inventoryLedgerForm" class="row g-3 align-items-end">
            <div class="col-md-6">
        ...
        <div class="table-responsive">
            <table class="table table-striped" id="inventoryLedgerTable">
                <thead>
                    <tr>
                        <th>S.no</th>
                        <th>Date</th>
...
$(function () {
    ...
    const table = $('#inventoryLedgerTable').DataTable({
        processing: true,
        serverSide: true,
        deferLoading: 0,
        ajax: {
            url: '{{ route('inventory-ledger.search') }}',
            type: 'POST',
            data: function (d) {
        ...
        buttons: [
            ...
            { extend: 'csv', text: '<i class="bi bi-filetype-csv me-1"></i> CSV', className: 'btn buttons-csv', title: 'Inventory Ledger', exportOptions: { columns: [0,1,2,3,4,5,6,7] } },
            { extend: 'excel', text: '<i class="bi bi-file-earmark-excel me-1"></i> Excel', className: 'btn buttons-excel', title: 'Inventory Ledger', exportOptions: { columns: [0,1,2,3,4,5,6,7] } },
            { extend: 'pdf', text: '<i class="bi bi-file-earmark-pdf me-1"></i> PDF', className: 'btn buttons-pdf', title: 'Inventory Ledger', orientation: 'landscape', pageSize: 'A4', exportOptions: { columns: [0,1,2,3,4,5,6,7] } },
            { extend: 'print', text: '<i class="bi bi-printer me-1"></i> Print', className: 'btn buttons-print', title: 'Inventory Ledger', exportOptions: { columns: [0,1,2,3,4,5,6,7] } },
        ],
        language: {
    ...
    $('#printBtn').on('click', function () {
        ...
        const url = '{{ route('inventory-ledger.print') }}' + '?start_date=' + start + '&end_date=' + end;
