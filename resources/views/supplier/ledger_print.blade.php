...
@section('title', 'Supplier Ledger - ' . $supplier->first_name . ' ' . $supplier->last_name)
...
@section('print_content')
    ...
    {{-- Title Box --}}
    <div class="title-box">
        <div class="title-inner">{{ $documentTitle ?? 'Supplier Ledger' }}</div>
    </div>
    ...
    <div class="info-grid-2col">
        <div>
            <div class="row-line">
                ...
                <span class="value">{{ $supplier->first_name . ' ' . $supplier->last_name }}</span>
            </div>
            <div class="row-line">
                <span class="label">Company:</span>
                <span class="value">{{ $supplier->company_name ?? 'N/A' }}</span>
            </div>
            <div class="row-line">
