...
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('customer-payments.index') }}" class="text-decoration-none text-muted">Customer Payments</a></li>
            ...
            <div class="card mb-4">
                <div class="card-header">
                    ...
                    <div>
                        ...
                        <p class="card-subtitle">Record a customer payment</p>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row g-3">
...
<script>
    $(document).ready(function () {
        $('#generateBtn').click(function () {
            $.ajax({
                url: '{{ route("customer-payments.generate-voucher-no") }}',
                type: 'GET',
