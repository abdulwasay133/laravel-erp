...
@section('title', 'Inventory Ledger - ' . $start->format('d M, Y') . ' — ' . $end->format('d M, Y'))
...
@section('print_content')
    ...
    <div class="title-box">
        <div class="title-inner">{{ $documentTitle ?? 'Inventory Ledger' }}</div>
    </div>
    ...
    <table class="print-table">
        <thead>
            <tr>
                ...
                <th style="width: 16%;" class="text-end">Credit (Rs.)</th>
            </tr>
        </thead>
        <tbody>
