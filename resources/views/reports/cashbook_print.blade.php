...
@section('title', 'Cashbook - ' . $start->format('d M, Y') . ' — ' . $end->format('d M, Y'))
...
@section('print_content')
    ...
    <div class="title-box">
        <div class="title-inner">{{ $documentTitle ?? 'Cashbook' }}</div>
    </div>
    ...
    <table class="print-table">
        <thead>
            <tr>
                ...
                <th style="width: 14%;" class="text-end">Credit (Rs.)</th>
            </tr>
        </thead>
        <tbody>
